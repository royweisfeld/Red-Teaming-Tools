...
def runDolPhin(category_selected='all', subcategories={}, password=None):
    """
...
if __name__ == '__main__':
    ...
    for r in runDolPhin(category_selected=category, subcategories=subcategories, password=args.get('password', None)):
        pass
